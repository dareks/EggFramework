...
public class ActionValidationConfig {
    ...
    private static final Map<String, ActionValidationConfig> config = Maps.newHashMap();
    ...
    public synchronized ActionValidationConfig add(String name, Validator... validators) {
